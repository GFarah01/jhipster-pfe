...
To build the final jar and optimize the servicePFE application for production, run:
...
Then navigate to [http://localhost:8041](http://localhost:8041) in your browser.
